...
public class TabLatestWallpapers extends Fragment implements OnLoadMoreListener {
    ...
    public void init(View v) {
        ...
        rcLatestWallpaper.setLayoutManager(gridLayoutManager);
        ...
        pageAdapter = new PageAdapter(rcLatestWallpaper, arrI, link, GetPage.LATEST_WALLPAPER);
        rcLatestWallpaper.setAdapter(pageAdapter);
    ...
    public void onResume() {
        super.onResume();
        MyLog.e("TabLatest: resume");
    }

    @Override
    public void onPause() {
        super.onPause();
        MyLog.e("TabLatest: pause");
    }
}